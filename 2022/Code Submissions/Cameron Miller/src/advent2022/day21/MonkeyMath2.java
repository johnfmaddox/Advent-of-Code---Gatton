...
public class MonkeyMath2 {
    public static void main(String[] args) throws FileNotFoundException{
        ...
        long offBy = 25367795610762L; //default value found by runing a loop with the starting value
        ...
        while (true) {
            ...
            monkeys[findName("humn", monkeys)].setVal((val));
            ...
            int root = findName("root", monkeys);
            if (monkeys[root].others[0].getVal() == (monkeys[root].others[1].getVal())){
                break;
            } else {
                offBy = (monkeys[root].others[0].getVal() - monkeys[root].others[1].getVal());
            }
        }
